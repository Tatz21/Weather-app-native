...
export default class App extends React.Component{
  ...
  fetch_weather=()=> {
    fetch('http://api.openweathermap.org/data/2.5/weather?q='+this.state.city+'&appid=3a2854423c6f73d96fbe4664414e93f8') 
  ...
  render(){
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ImageBackground source={{uri:"https://www.hindustantimes.com/rf/image_size_960x540/HT/p2/2020/07/27/Pictures/india-weather_8be8966a-cffb-11ea-9dd6-4d0195c6d4b2.jpg"}} 
